...
if __name__ == "__main__":
    ...
    target_feature_pkl = "/path/to/target/model/trained/using/MNIST/feature_extractor.pkl"
    target_cls_pkl = "/path/to/target/model/trained/using/MNIST/cls.pkl"
    aux_feature_pkl = "/path/to/auxiliary/classifier/trained/using/USPS/feature_extractor.pkl"
    aux_cls_pkl = "/path/to/auxiliary/classifier/trained/using/USPS/cls.pkl"
    h = 32
    w = 32
    lr = 0.01
    momentum = 0.9
    ...
    init = Init(
        ...
        tensorboard=True,
        comment=f"USPS DATTACKB U2M BLACK",
    )
    ...
    usps_train_ds = USPS(root="./data", train=True, transform=transform, download=True)
    usps_test_ds = USPS(root="./data", train=False, transform=transform, download=True)
