...
if __name__ == "__main__":
    ...
    feature_pkl = "/path/to/target/model/trained/using/MNIST/feature_extractor.pkl"
    cls_pkl = "/path/to/target/model/trained/using/MNIST/cls.pkl"
    ...
    init = Init(
        ...
        tensorboard=True,
        comment=f"U2M export newfe dattack",
    )
    ...
    mnist_test_ds = USPS(root="./data", train=True, transform=transform, download=True)
