...
from torchplus.utils import Init, MMD, save_image2
...
if __name__ == "__main__":
    ...
    feature_pkl = "/path/to/target/model/trained/using/CelebA/feature_extractor.pkl"
    cls_pkl = "/path/to/target/model/trained/using/CelebA/cls.pkl"
    priv_dataset_dir = "./datasets/img_align_celeba_common_crop"
    aux_dataset_dir = "./datasets/facescrub common"
    h = 64
    w = 64
    lr = 0.01
    momentum = 0.9
    ...
    init = Init(
        ...
        tensorboard=True,
        comment=f"CelebA DATTACK F2C colorful newfe 8192 flip",
    )
