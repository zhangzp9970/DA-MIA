...
if __name__ == "__main__":
    ...
    target_feature_pkl = (
        "/path/to/target/model/trained/using/FaceScrub/feature_extractor.pkl"
    )
    target_cls_pkl = "/path/to/target/model/trained/using/FaceScrub/cls.pkl"
    priv_dataset_dir = "/path/to/facescrub common/dataset"

    aux_feature_pkl = (
        "/path/to/auxiliary/classifier/trained/using/CelebA/feature_extractor.pkl"
    )
    aux_cls_pkl = "/path/to/auxiliary/classifier/trained/using/CelebA/cls.pkl"
    aux_dataset_dir = "/path/to/img_align_celeba_common_crop/dataset"
    h = 64
    w = 64
    lr = 0.01
    momentum = 0.9
